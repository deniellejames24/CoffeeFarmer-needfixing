...
function CoffeeTree({ position = [-19, -5, 3], scale = 10 }) {
  const materials = useLoader(MTLLoader, '/src/assets/models/a-coffee-tree/source/coffee-step00002/coffee-step00002.mtl');
  const obj = useLoader(OBJLoader, '/src/assets/models/a-coffee-tree/source/coffee-step00002/coffee-step00002.obj', (loader) => {
    materials.preload();
